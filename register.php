...
<select name="gender" id="gender" required>
  ...
  <option value="Other">Other</option>
      ...
      <!-- Email + Get OTP -->
    <div class="email-row" style="display: flex; gap: 10px; align-items: center;">
      <input type="email" name="email" placeholder="Email Address" required style="flex: 1;">
      <button type="button" id ="getotp" onclick="sendOTP()"  style=" margin:-2px" style="padding: 8px 1px; cursor: pointer;">Get OTP</button>
    </div>
